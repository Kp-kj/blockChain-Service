...
func (c *blockClient) FullPurchase(ctx context.Context, in *PurchaseRequest, opts ...grpc.CallOption) (*IsSuccessResponse, error) {
	out := new(IsSuccessResponse)
...
type BlockServer interface {
	...
	FullPurchase(context.Context, *PurchaseRequest) (*IsSuccessResponse, error)
...
func (UnimplementedBlockServer) FullPurchase(context.Context, *PurchaseRequest) (*IsSuccessResponse, error) {
