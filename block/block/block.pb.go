...
type IsSuccessResponse struct {
	...
	IsSuccess bool `protobuf:"varint,1,opt,name=is_success,json=isSuccess,proto3" json:"is_success,omitempty"` // 成功
}
...
type AdminGood struct {
	...
	GoodType     string `protobuf:"bytes,7,opt,name=good_type,json=goodType,proto3" json:"good_type,omitempty"`              // 商品类型  0：胡萝卜 1：能量水
	GoodPower    int64  `protobuf:"varint,8,opt,name=good_power,json=goodPower,proto3" json:"good_power,omitempty"`          // 商品算力
}
...
func (x *AdminGood) GetGoodType() string {
	if x != nil {
		return x.GoodType
	}
	return ""
...
func (x *AdminGood) GetGoodPower() int64 {
	if x != nil {
		return x.GoodPower
	}
	return 0
...
type JudgeBargainResponse struct {
	...
	IsBargain           bool   `protobuf:"varint,1,opt,name=is_bargain,json=isBargain,proto3" json:"is_bargain,omitempty"`   // 是否可以砍价（今日是否已经砍过）
	BargainRuleDescribe string `protobuf:"bytes,2,opt,name=bargainRuleDescribe,proto3" json:"bargainRuleDescribe,omitempty"` // 规则描述
	IsFirst             bool   `protobuf:"varint,3,opt,name=is_first,json=isFirst,proto3" json:"is_first,omitempty"`         // 是否为第一次砍价
}
...
func (x *JudgeBargainResponse) GetBargainRuleDescribe() string {
	if x != nil {
...
func (x *JudgeBargainResponse) GetIsFirst() bool {
	if x != nil {
		return x.IsFirst
	}
	return false
...
type CryptominerBargainResponse struct {
	...
	BargainId int64 `protobuf:"varint,1,opt,name=bargain_id,json=bargainId,proto3" json:"bargain_id,omitempty"` // 砍价活动id
}
...
type GetBargainRecordRequest struct {
	...
	UserId    int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`          // 用户id
	BargainId int64 `protobuf:"varint,2,opt,name=bargain_id,json=bargainId,proto3" json:"bargain_id,omitempty"` // 砍价活动id
}
...
func (x *GetBargainRecordRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type GetBargainRecordResponse struct {
	...
	BargainRecord *BargainRecord `protobuf:"bytes,1,opt,name=BargainRecord,proto3" json:"BargainRecord,omitempty"`                // 砍价记录
	LoginStatus   string         `protobuf:"bytes,2,opt,name=login_status,json=loginStatus,proto3" json:"login_status,omitempty"` // 登陆状态 0：砍价发起人 1:助力人
	InActivity    bool           `protobuf:"varint,3,opt,name=in_activity,json=inActivity,proto3" json:"in_activity,omitempty"`   // 是否活动中，false包括倒计时结束，提前付款结束
	BargainMax    bool           `protobuf:"varint,4,opt,name=bargain_max,json=bargainMax,proto3" json:"bargain_max,omitempty"`   // 砍价次数已达上限
	IsBargain     bool           `protobuf:"varint,5,opt,name=is_bargain,json=isBargain,proto3" json:"is_bargain,omitempty"`      // 是否可以砍价
}
...
func (x *GetBargainRecordResponse) GetBargainRecord() *BargainRecord {
	if x != nil {
		return x.BargainRecord
	}
	return nil
}

func (x *GetBargainRecordResponse) GetLoginStatus() string {
	if x != nil {
...
func (x *GetBargainRecordResponse) GetInActivity() bool {
	if x != nil {
		return x.InActivity
	}
	return false
...
func (x *GetBargainRecordResponse) GetBargainMax() bool {
	if x != nil {
		return x.BargainMax
	}
	return false
...
func (x *GetBargainRecordResponse) GetIsBargain() bool {
	if x != nil {
		return x.IsBargain
	}
	return false
...
type BargainRecord struct {
	...
	CryptominerName    string         `protobuf:"bytes,2,opt,name=cryptominer_name,json=cryptominerName,proto3" json:"cryptominer_name,omitempty"`          // 矿机名称
	CryptominerPicture string         `protobuf:"bytes,3,opt,name=cryptominer_picture,json=cryptominerPicture,proto3" json:"cryptominer_picture,omitempty"` // 矿机图片
	CryptominerPrice   int64          `protobuf:"varint,4,opt,name=cryptominer_price,json=cryptominerPrice,proto3" json:"cryptominer_price,omitempty"`      // 矿机价格
	ActivityStartTime  int64          `protobuf:"varint,5,opt,name=activity_start_time,json=activityStartTime,proto3" json:"activity_start_time,omitempty"` // 开始时间
	RemainingPrice     float32        `protobuf:"fixed32,6,opt,name=remaining_price,json=remainingPrice,proto3" json:"remaining_price,omitempty"`           // 剩余金额
	SupportUser        []*SupportUser `protobuf:"bytes,7,rep,name=SupportUser,proto3" json:"SupportUser,omitempty"`                                         //助力人信息
}
...
func (x *BargainRecord) GetCryptominerPicture() string {
	if x != nil {
		return x.CryptominerPicture
	}
	return ""
...
func (x *BargainRecord) GetCryptominerPrice() int64 {
	if x != nil {
		return x.CryptominerPrice
	}
	return 0
...
func (x *BargainRecord) GetActivityStartTime() int64 {
	if x != nil {
...
func (x *BargainRecord) GetRemainingPrice() float32 {
	if x != nil {
...
func (x *BargainRecord) GetSupportUser() []*SupportUser {
	if x != nil {
		return x.SupportUser
	}
	return nil
}
...
type SupportUser struct {
	...
	AssistorId   int64   `protobuf:"varint,1,opt,name=assistor_id,json=assistorId,proto3" json:"assistor_id,omitempty"`        // 助力人id
	AssistorName string  `protobuf:"bytes,2,opt,name=assistor_name,json=assistorName,proto3" json:"assistor_name,omitempty"`   // 助力人名
	TwitterName  string  `protobuf:"bytes,3,opt,name=twitter_name,json=twitterName,proto3" json:"twitter_name,omitempty"`      // 助力人名
	Avatar       string  `protobuf:"bytes,4,opt,name=avatar,proto3" json:"avatar,omitempty"`                                   // 助力人头像
	BargainPrice float32 `protobuf:"fixed32,5,opt,name=bargain_price,json=bargainPrice,proto3" json:"bargain_price,omitempty"` // 本次砍价额度
}

func (x *SupportUser) Reset() {
	*x = SupportUser{}
	if protoimpl.UnsafeEnabled {
...
func (x *SupportUser) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SupportUser) ProtoMessage() {}

func (x *SupportUser) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SupportUser.ProtoReflect.Descriptor instead.
func (*SupportUser) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{26}
}

func (x *SupportUser) GetAssistorId() int64 {
	if x != nil {
		return x.AssistorId
	}
	return 0
...
func (x *SupportUser) GetAssistorName() string {
	if x != nil {
		return x.AssistorName
	}
	return ""
}

func (x *SupportUser) GetTwitterName() string {
	if x != nil {
...
func (x *SupportUser) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *SupportUser) GetBargainPrice() float32 {
	if x != nil {
...
type PurchaseRecord struct {
	...
	PurchaseWay      string  `protobuf:"bytes,8,opt,name=purchase_way,json=purchaseWay,proto3" json:"purchase_way,omitempty"`                   // 购买方式 0：全额购买 1：限时砍价
	PaymentWay       string  `protobuf:"bytes,9,opt,name=payment_way,json=paymentWay,proto3" json:"payment_way,omitempty"`                      // 支付方式 0：U ,1:ADF
}
...
// 好友助力
type AssistorBargainRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId       int64   `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                    // 助力人id
	UserName     string  `protobuf:"bytes,2,opt,name=user_name,json=userName,proto3" json:"user_name,omitempty"`               // 助力人名
	TwitterName  string  `protobuf:"bytes,3,opt,name=twitter_name,json=twitterName,proto3" json:"twitter_name,omitempty"`      // 助力人推特名
	Avatar       string  `protobuf:"bytes,4,opt,name=avatar,proto3" json:"avatar,omitempty"`                                   // 助力人头像
	BargainPrice float32 `protobuf:"fixed32,5,opt,name=bargain_price,json=bargainPrice,proto3" json:"bargain_price,omitempty"` // 帮砍金额
	BargainId    int64   `protobuf:"varint,6,opt,name=bargain_id,json=bargainId,proto3" json:"bargain_id,omitempty"`           // 砍价活动id
}

func (x *AssistorBargainRequest) Reset() {
	*x = AssistorBargainRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AssistorBargainRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssistorBargainRequest) ProtoMessage() {}

func (x *AssistorBargainRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssistorBargainRequest.ProtoReflect.Descriptor instead.
func (*AssistorBargainRequest) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{31}
}

func (x *AssistorBargainRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AssistorBargainRequest) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *AssistorBargainRequest) GetTwitterName() string {
	if x != nil {
		return x.TwitterName
	}
	return ""
...
func (x *AssistorBargainRequest) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *AssistorBargainRequest) GetBargainPrice() float32 {
	if x != nil {
		return x.BargainPrice
	}
	return 0
...
func (x *AssistorBargainRequest) GetBargainId() int64 {
	if x != nil {
		return x.BargainId
	}
	return 0
...
// 好友助力
type AssistorBargainResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UnuserArr  string `protobuf:"bytes,1,opt,name=unuser_arr,json=unuserArr,proto3" json:"unuser_arr,omitempty"`     // 返回数据(当缓存存在时返回空)
	RedisExist bool   `protobuf:"varint,2,opt,name=redis_exist,json=redisExist,proto3" json:"redis_exist,omitempty"` // 缓存是否存在
}

func (x *AssistorBargainResponse) Reset() {
	*x = AssistorBargainResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AssistorBargainResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssistorBargainResponse) ProtoMessage() {}

func (x *AssistorBargainResponse) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssistorBargainResponse.ProtoReflect.Descriptor instead.
func (*AssistorBargainResponse) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{32}
}

func (x *AssistorBargainResponse) GetUnuserArr() string {
	if x != nil {
		return x.UnuserArr
	}
	return ""
...
func (x *AssistorBargainResponse) GetRedisExist() bool {
	if x != nil {
		return x.RedisExist
	}
	return false
...
// 矿机砍价支付
type BargainPayRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId        int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                      // 用户id
	CryptominerId int64 `protobuf:"varint,2,opt,name=cryptominer_id,json=cryptominerId,proto3" json:"cryptominer_id,omitempty"` // 商品id
}

func (x *BargainPayRequest) Reset() {
	*x = BargainPayRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BargainPayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BargainPayRequest) ProtoMessage() {}

func (x *BargainPayRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BargainPayRequest.ProtoReflect.Descriptor instead.
func (*BargainPayRequest) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{33}
}

func (x *BargainPayRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *BargainPayRequest) GetCryptominerId() int64 {
	if x != nil {
		return x.CryptominerId
	}
	return 0
...
type JudgeGoodsPurchaseResponse struct {
	...
	IsPurchase bool `protobuf:"varint,1,opt,name=is_purchase,json=isPurchase,proto3" json:"is_purchase,omitempty"` // 是否购买过
}
...
// 钱包--获取矿机状态
type GetUserCryptominerStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetUserCryptominerStatusRequest) Reset() {
	*x = GetUserCryptominerStatusRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserCryptominerStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserCryptominerStatusRequest) ProtoMessage() {}

func (x *GetUserCryptominerStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserCryptominerStatusRequest.ProtoReflect.Descriptor instead.
func (*GetUserCryptominerStatusRequest) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{36}
}

func (x *GetUserCryptominerStatusRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
// 钱包--获取矿机状态
type GetUserCryptominerStatusResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserCryptominer []*UserCryptominer `protobuf:"bytes,1,rep,name=UserCryptominer,proto3" json:"UserCryptominer,omitempty"`
}

func (x *GetUserCryptominerStatusResponse) Reset() {
	*x = GetUserCryptominerStatusResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserCryptominerStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserCryptominerStatusResponse) ProtoMessage() {}

func (x *GetUserCryptominerStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[37]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserCryptominerStatusResponse.ProtoReflect.Descriptor instead.
func (*GetUserCryptominerStatusResponse) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{37}
}

func (x *GetUserCryptominerStatusResponse) GetUserCryptominer() []*UserCryptominer {
	if x != nil {
		return x.UserCryptominer
	}
	return nil
}

// 用户矿机
type UserCryptominer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	CryptominerName    string `protobuf:"bytes,2,opt,name=cryptominer_name,json=cryptominerName,proto3" json:"cryptominer_name,omitempty"`            // 矿机名称
	CryptominerPicture string `protobuf:"bytes,3,opt,name=cryptominer_picture,json=cryptominerPicture,proto3" json:"cryptominer_picture,omitempty"`   // 矿机图片
	OptionalStatus     string `protobuf:"bytes,4,opt,name=optional_status,json=optionalStatus,proto3" json:"optional_status,omitempty"`               // 矿机状态 1：工作中 2：已失效
	CryptominerEndTime string `protobuf:"bytes,5,opt,name=cryptominer_end_time,json=cryptominerEndTime,proto3" json:"cryptominer_end_time,omitempty"` // 矿机失效时间
}

func (x *UserCryptominer) Reset() {
	*x = UserCryptominer{}
	if protoimpl.UnsafeEnabled {
...
func (x *UserCryptominer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserCryptominer) ProtoMessage() {}

func (x *UserCryptominer) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserCryptominer.ProtoReflect.Descriptor instead.
func (*UserCryptominer) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{38}
}

func (x *UserCryptominer) GetCryptominerId() int64 {
	if x != nil {
		return x.CryptominerId
	}
	return 0
...
func (x *UserCryptominer) GetCryptominerName() string {
	if x != nil {
		return x.CryptominerName
	}
	return ""
...
func (x *UserCryptominer) GetCryptominerPicture() string {
	if x != nil {
		return x.CryptominerPicture
	}
	return ""
...
func (x *UserCryptominer) GetOptionalStatus() string {
	if x != nil {
		return x.OptionalStatus
	}
	return ""
...
func (x *UserCryptominer) GetCryptominerEndTime() string {
	if x != nil {
		return x.CryptominerEndTime
	}
	return ""
...
// 钱包--获取道具状态
type GetUserPropStatusRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetUserPropStatusRequest) Reset() {
	*x = GetUserPropStatusRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserPropStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserPropStatusRequest) ProtoMessage() {}

func (x *GetUserPropStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserPropStatusRequest.ProtoReflect.Descriptor instead.
func (*GetUserPropStatusRequest) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{39}
}

func (x *GetUserPropStatusRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
// 钱包--获取道具状态
type GetUserPropStatusResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserProp []*UserProp `protobuf:"bytes,1,rep,name=UserProp,proto3" json:"UserProp,omitempty"`
}

func (x *GetUserPropStatusResponse) Reset() {
	*x = GetUserPropStatusResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetUserPropStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserPropStatusResponse) ProtoMessage() {}

func (x *GetUserPropStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserPropStatusResponse.ProtoReflect.Descriptor instead.
func (*GetUserPropStatusResponse) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{40}
}

func (x *GetUserPropStatusResponse) GetUserProp() []*UserProp {
	if x != nil {
		return x.UserProp
	}
	return nil
...
type UserProp struct {
	...
	PropId      int64  `protobuf:"varint,1,opt,name=prop_id,json=propId,proto3" json:"prop_id,omitempty"`               // ID
	PropName    string `protobuf:"bytes,2,opt,name=prop_name,json=propName,proto3" json:"prop_name,omitempty"`          // 道具名称
	PropPicture string `protobuf:"bytes,3,opt,name=prop_picture,json=propPicture,proto3" json:"prop_picture,omitempty"` // 道具图片
}
...
func (x *UserProp) GetPropId() int64 {
	if x != nil {
		return x.PropId
	}
	return 0
...
func (x *UserProp) GetPropName() string {
	if x != nil {
		return x.PropName
	}
	return ""
...
func (x *UserProp) GetPropPicture() string {
	if x != nil {
		return x.PropPicture
	}
	return ""
...
// 钱包--激活矿机
type ActivateCryptominerRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ActivateCryptominerRequest) Reset() {
	*x = ActivateCryptominerRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ActivateCryptominerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivateCryptominerRequest) ProtoMessage() {}

func (x *ActivateCryptominerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivateCryptominerRequest.ProtoReflect.Descriptor instead.
func (*ActivateCryptominerRequest) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{42}
}

func (x *ActivateCryptominerRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ActivateCryptominerRequest) GetCryptominerId() int64 {
	if x != nil {
		return x.CryptominerId
	}
	return 0
...
// 钱包--激活矿机
type ActivateCryptominerResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IsSuccess  bool `protobuf:"varint,1,opt,name=is_success,json=isSuccess,proto3" json:"is_success,omitempty"`    // 成功
	PropEnough bool `protobuf:"varint,2,opt,name=prop_enough,json=propEnough,proto3" json:"prop_enough,omitempty"` // 能量水是否充足
}

func (x *ActivateCryptominerResponse) Reset() {
	*x = ActivateCryptominerResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ActivateCryptominerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivateCryptominerResponse) ProtoMessage() {}

func (x *ActivateCryptominerResponse) ProtoReflect() protoreflect.Message {
	mi := &file_block_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivateCryptominerResponse.ProtoReflect.Descriptor instead.
func (*ActivateCryptominerResponse) Descriptor() ([]byte, []int) {
	return file_block_proto_rawDescGZIP(), []int{43}
}

func (x *ActivateCryptominerResponse) GetIsSuccess() bool {
	if x != nil {
		return x.IsSuccess
	}
	return false
...
func (x *ActivateCryptominerResponse) GetPropEnough() bool {
	if x != nil {
		return x.PropEnough
	}
	return false
...
var file_block_proto_rawDesc = []byte{
	...
	0x6e, 0x47, 0x6f, 0x6f, 0x64, 0x22, 0x8b, 0x02, 0x0a, 0x09, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x47,
	...
	0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x67, 0x6f, 0x6f, 0x64, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x67, 0x6f, 0x6f, 0x64,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x67, 0x6f, 0x6f, 0x64, 0x5f, 0x70, 0x6f, 0x77,
	0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x67, 0x6f, 0x6f, 0x64, 0x50, 0x6f,
	0x77, 0x65, 0x72, 0x22, 0x2e, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x47, 0x6f, 0x6f, 0x64, 0x73, 0x4c,
	...
	0x6f, 0x70, 0x22, 0xb1, 0x05, 0x0a, 0x0b, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x6d, 0x69, 0x6e,
	...
	,
	...
	0x61, 0x69, 0x6e, 0x12, 0x30, 0x0a, 0x13, 0x62, 0x61, 0x72, 0x67, 0x61, 0x69, 0x6e, 0x52, 0x75,
	0x6c, 0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x13, 0x62, 0x61, 0x72, 0x67, 0x61, 0x69, 0x6e, 0x52, 0x75, 0x6c, 0x65, 0x44, 0x65, 0x73,
	0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x66, 0x69, 0x72, 0x73,
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x46, 0x69, 0x72, 0x73, 0x74,
	0x22, 0x5c, 0x0a, 0x1a, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x6d, 0x69, 0x6e, 0x65, 0x72, 0x50,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x74, 0x77, 0x69, 0x74, 0x74, 0x65,
	0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x74, 0x77,
	0x69, 0x74, 0x74, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x76, 0x61,
	...
	,
	...
	,
	...
	,
...
var file_block_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_block_proto_goTypes = []interface{}{
	...
	(*CryptominerBargainResponse)(nil),       // 22: block.CryptominerBargainResponse
	(*GetBargainRecordRequest)(nil),          // 23: block.GetBargainRecordRequest
	(*GetBargainRecordResponse)(nil),         // 24: block.GetBargainRecordResponse
	(*BargainRecord)(nil),                    // 25: block.BargainRecord
	(*SupportUser)(nil),                      // 26: block.SupportUser
	(*PropPurchaseRequest)(nil),              // 27: block.PropPurchaseRequest
	(*GetPurchaseRecordRequest)(nil),         // 28: block.GetPurchaseRecordRequest
	(*GetPurchaseRecordResponse)(nil),        // 29: block.GetPurchaseRecordResponse
	(*PurchaseRecord)(nil),                   // 30: block.PurchaseRecord
	(*AssistorBargainRequest)(nil),           // 31: block.AssistorBargainRequest
	(*AssistorBargainResponse)(nil),          // 32: block.AssistorBargainResponse
	(*BargainPayRequest)(nil),                // 33: block.BargainPayRequest
	(*JudgeGoodsPurchaseRequest)(nil),        // 34: block.JudgeGoodsPurchaseRequest
	(*JudgeGoodsPurchaseResponse)(nil),       // 35: block.JudgeGoodsPurchaseResponse
	(*GetUserCryptominerStatusRequest)(nil),  // 36: block.GetUserCryptominerStatusRequest
	(*GetUserCryptominerStatusResponse)(nil), // 37: block.GetUserCryptominerStatusResponse
	(*UserCryptominer)(nil),                  // 38: block.UserCryptominer
	(*GetUserPropStatusRequest)(nil),         // 39: block.GetUserPropStatusRequest
	(*GetUserPropStatusResponse)(nil),        // 40: block.GetUserPropStatusResponse
	(*UserProp)(nil),                         // 41: block.UserProp
	(*ActivateCryptominerRequest)(nil),       // 42: block.ActivateCryptominerRequest
	(*ActivateCryptominerResponse)(nil),      // 43: block.ActivateCryptominerResponse
}
var file_block_proto_depIdxs = []int32{
	...
	25, // 4: block.GetBargainRecordResponse.BargainRecord:type_name -> block.BargainRecord
	26, // 5: block.BargainRecord.SupportUser:type_name -> block.SupportUser
	30, // 6: block.GetPurchaseRecordResponse.PurchaseRecord:type_name -> block.PurchaseRecord
	38, // 7: block.GetUserCryptominerStatusResponse.UserCryptominer:type_name -> block.UserCryptominer
	41, // 8: block.GetUserPropStatusResponse.UserProp:type_name -> block.UserProp
	0,  // 9: block.Block.Ping:input_type -> block.Request
	2,  // 10: block.Block.CreateCryptominer:input_type -> block.CreateCryptominerRequest
	4,  // 11: block.Block.CreateProp:input_type -> block.CreatePropRequest
	11, // 12: block.Block.AdminGoodList:input_type -> block.AdminGoodListRequest
	7,  // 13: block.Block.StartGood:input_type -> block.StartGoodRequest
	5,  // 14: block.Block.CreateActivity:input_type -> block.CreateActivityRequest
	8,  // 15: block.Block.AdminActivityList:input_type -> block.AdminActivityListRequest
	6,  // 16: block.Block.StartActivity:input_type -> block.StartActivityRequest
	14, // 17: block.Block.GetGoodsList:input_type -> block.GetGoodsListRequest
	28, // 18: block.Block.GetPurchaseRecord:input_type -> block.GetPurchaseRecordRequest
	18, // 19: block.Block.JudgeBargain:input_type -> block.JudgeBargainRequest
	20, // 20: block.Block.CryptominerFullPurchase:input_type -> block.CryptominerPurchaseRequest
	27, // 21: block.Block.PropPurchase:input_type -> block.PropPurchaseRequest
	21, // 22: block.Block.CryptominerBargainPurchase:input_type -> block.CryptominerBargainRequest
	31, // 23: block.Block.AssistorBargain:input_type -> block.AssistorBargainRequest
	23, // 24: block.Block.GetBargainRecord:input_type -> block.GetBargainRecordRequest
	33, // 25: block.Block.BargainPay:input_type -> block.BargainPayRequest
	34, // 26: block.Block.JudgeGoodsPurchase:input_type -> block.JudgeGoodsPurchaseRequest
	36, // 27: block.Block.GetUserCryptominerStatus:input_type -> block.GetUserCryptominerStatusRequest
	39, // 28: block.Block.GetUserPropStatus:input_type -> block.GetUserPropStatusRequest
	42, // 29: block.Block.ActivateCryptominer:input_type -> block.ActivateCryptominerRequest
	1,  // 30: block.Block.Ping:output_type -> block.Response
	3,  // 31: block.Block.CreateCryptominer:output_type -> block.IsSuccessResponse
	3,  // 32: block.Block.CreateProp:output_type -> block.IsSuccessResponse
	12, // 33: block.Block.AdminGoodList:output_type -> block.AdminGoodListResponse
	3,  // 34: block.Block.StartGood:output_type -> block.IsSuccessResponse
	3,  // 35: block.Block.CreateActivity:output_type -> block.IsSuccessResponse
	9,  // 36: block.Block.AdminActivityList:output_type -> block.AdminActivityListResponse
	3,  // 37: block.Block.StartActivity:output_type -> block.IsSuccessResponse
	15, // 38: block.Block.GetGoodsList:output_type -> block.GetGoodsListResponse
	29, // 39: block.Block.GetPurchaseRecord:output_type -> block.GetPurchaseRecordResponse
	19, // 40: block.Block.JudgeBargain:output_type -> block.JudgeBargainResponse
	3,  // 41: block.Block.CryptominerFullPurchase:output_type -> block.IsSuccessResponse
	3,  // 42: block.Block.PropPurchase:output_type -> block.IsSuccessResponse
	22, // 43: block.Block.CryptominerBargainPurchase:output_type -> block.CryptominerBargainResponse
	32, // 44: block.Block.AssistorBargain:output_type -> block.AssistorBargainResponse
	24, // 45: block.Block.GetBargainRecord:output_type -> block.GetBargainRecordResponse
	3,  // 46: block.Block.BargainPay:output_type -> block.IsSuccessResponse
	35, // 47: block.Block.JudgeGoodsPurchase:output_type -> block.JudgeGoodsPurchaseResponse
	37, // 48: block.Block.GetUserCryptominerStatus:output_type -> block.GetUserCryptominerStatusResponse
	40, // 49: block.Block.GetUserPropStatus:output_type -> block.GetUserPropStatusResponse
	43, // 50: block.Block.ActivateCryptominer:output_type -> block.ActivateCryptominerResponse
...
func file_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_block_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AssistorBargainRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AssistorBargainResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BargainPayRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserCryptominerStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserCryptominerStatusResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserPropStatusRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserPropStatusResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActivateCryptominerRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_block_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ActivateCryptominerResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
