...
func (m *defaultManageCryptominerModel) SelectAllProp(ctx context.Context ) ([]*ManageProp, error) {
...
func (m *defaultManageCryptominerModel) FindOneByPropName(ctx context.Context, goodName int64) (*ManageProp, error) {
	query := fmt.Sprintf("select %s from %s where `id` = ? limit 1", managePropRows, m.table)
	var resp ManageProp
