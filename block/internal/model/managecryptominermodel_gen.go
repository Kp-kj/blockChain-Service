...
func (m *defaultManageCryptominerModel) FindOneByCryptominerName(ctx context.Context, goodName int64) (*ManageCryptominer, error) {
	query := fmt.Sprintf("select %s from %s where `id` = ? limit 1", manageCryptominerRows, m.table)
	var resp ManageCryptominer
